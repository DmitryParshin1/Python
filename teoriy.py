...
# new_string3 = my_string.replace('и', '$').replace('а', '')   #  замена элементов, можно использвать много раз  

# print(my_string)                 # Питон самый лучший в мире язык
# print(new_string)                # ['Питон', 'самый', 'лучший', 'в', 'мире', 'язык']  - список образует !!!!!!
# print(new_string2)               # ['П', 'тон самый лучш', 'й в м', 'ре язык'] - пример
# print(new_string3)               # П$тон самый лучш$й в м$ре язык   - меняем элементы  на заданные
